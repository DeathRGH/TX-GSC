namespace T7_GSC
{
	partial class main
	{
		...
		private void InitializeComponent()
		{
			...
			this.button_inject = new T7_GSC.ButtonX();
			this.btn_makeDataBase = new T7_GSC.ButtonX();
			this.btn_dumpAllFiles = new T7_GSC.ButtonX();
			this.btn_dumpFile = new T7_GSC.ButtonX();
			this.btn_fetchLoadedFiles = new T7_GSC.ButtonX();
			this.btn_connect = new T7_GSC.ButtonX();
			this.box_ip = new T7_GSC.TextBoxX();
			...
			this.label_log.Size = new System.Drawing.Size(416, 375);
