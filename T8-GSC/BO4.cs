...
namespace T8_GSC.BO4
{
	namespace _01_25
	{
		class Addresses
		{
			public static ulong s_ScriptParseTreePool = 0x0000000004E4FDE8;
			public static ulong DB_FindXAssetHeader = 0x00000000011B6F40; //int DB_FindXAssetHeader(int type, const char *name, bool errorIfMissing, int unk, int waitTime)
		}
	}
	...
	namespace _01_26
	{
		class Addresses
		{
			public static ulong s_ScriptParseTreePool = 0x0000000004E2FFE8;
			//public static ulong DB_FindXAssetHeader = 0x00000000011B6F40; //int DB_FindXAssetHeader(int type, const char *name, bool errorIfMissing, int unk, int waitTime)
		}
	}
	...
	enum XAssetType : int
	{
		ASSET_TYPE_SCRIPTPARSETREE = 0x30 //0x29 ???
	}
	...
	public enum ScriptOpCode : byte
	{
		...
		VM_OP_GetEmptyArray_Handler = 0x1E,
		...
		VM_OP_SetLocalVariableCached_Handler = 0x8F,
		VM_OP_EvalLocalVariableDefined_Handler = 0x90,
		//JumpOnGreaterThan = 0x91,
		//SetVariableFieldRef = 0x92,
		VM_OP_CreateStruct_Handler = 0x93,
		VM_OP_AddToStruct_Handler = 0x94,
		VM_OP_GetGlobalObject_Handler = 0x95,
		//JumpOnLessThan = 0x96,
		VM_OP_GetGlobalObjectRef_Handler = 0x97,
		//EvalGlobalObjectFieldVariable = 0x98,
		VM_OP_WaitFrame_Handler = 0x99,
		VM_OP_CastAndEvalFieldVariable_Handler = 0x9A,
		VM_OP_FirstArrayKeyCached_Handler = 0x9B,
		VM_OP_SetNextArrayKeyCached_Handler = 0x9C,
		VM_OP_GetAPIFunction_Handler = 0x9D,
		VM_OP_GetUnsignedInteger_Handler = 0x9E,
		//CastVariableName = 0x9F,
		//EvalFieldVariableOnStack = 0xA0,
		//EvalFieldVariableOnStackRef = 0xA1,
		VM_OP_EndOnCallback_Handler = 0xA2,
		//WaittillTimeout = 0xA3,
		VM_OP_AddToArray_Handler = 0xA4,
		//ClassFunctionThreadCall = 0xA5,
		//ScriptThreadCall2 = 0xA6,
		//ScriptThreadCallPointer2 = 0xA7,
		//ScriptMethodThreadCall2 = 0xA8,
		//ScriptMethodThreadCallPointer2 = 0xA9,
		//ClassFunctionThreadCall2 = 0xAA,
		//EvalLocalVariableCached2 = 0xAB,
		//EvalLocalVariableRefCached2 = 0xAC,
